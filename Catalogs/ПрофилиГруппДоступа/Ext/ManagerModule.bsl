...
Функция ОписаниеРолейПрофиля(ОписаниеПрофиля)
	...
	Если Не ОбщегоНазначенияПовтИсп.РазделениеВключено() Тогда
		...
		Если ОписаниеПрофиля.Имя = "Администратор"
			И Не ПользователиСлужебныйПовтИсп.АдминистраторЗапретилОткрыватьВнешниеОтчетыИОбработки() Тогда
			ОписаниеРолейПрофиля = Новый Массив;
			Для Каждого Роль Из ОписаниеПрофиля.Роли Цикл
				ОписаниеРолейПрофиля.Добавить(Роль);
			КонецЦикла;
			Если ОписаниеРолейПрофиля.Найти("ИнтерактивноеОткрытиеВнешнихОтчетовИОбработок") = Неопределено Тогда
				ОписаниеРолейПрофиля.Добавить("ИнтерактивноеОткрытиеВнешнихОтчетовИОбработок");
			КонецЕсли;
