...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
    ...
    Обработчик.Версия = "*"; 
    Обработчик.Процедура = "ОбновлениеИнформационнойБазыМенеджментФирмы.ПервыйЗапуск"; 
...
Процедура ПервыйЗапуск() Экспорт 
	...
	Если ПланыОбмена.ГлавныйУзел() = Неопределено Тогда
        Константы.ЗаголовокСистемы.Установить("Менеджмент фирмы");
    КонецЕсли;
