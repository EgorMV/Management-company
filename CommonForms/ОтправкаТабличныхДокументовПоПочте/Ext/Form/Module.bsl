...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//+Егор, 09.01.2017, укажем формат отправки
	Если Параметры.Свойство("ФорматОтправки") Тогда
		ФорматыСохранения.НайтиПоЗначению(ТипФайлаТабличногоДокумента[Параметры.ФорматОтправки]).Пометка = Истина;	
	Иначе
