...
Процедура СотрудникиВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	СтандартнаяОбработка = Ложь;
	ТекСотрудник = Элементы.Сотрудники.ТекущиеДанные;
	
	НСтрока = ПолучателиСообщения.Добавить();
	НСтрока.Адрес 			= ТекСотрудник.ЭлектронныйАдрес;
	НСтрока.Представление 	= ТекСотрудник.Наименование;
	НСтрока.Выбран			= Истина;
	НСтрока.ПредставлениеАдреса = НСтрока.Представление+"<"+ТекСотрудник.ЭлектронныйАдрес+">";
